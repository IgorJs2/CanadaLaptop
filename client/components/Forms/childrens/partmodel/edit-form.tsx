...
const initialFormState: IPartModelEditData = {
    _id: "",
    searchID: "",
    name: "",
    price: "",
...
const PartModelEditForm: FC<IEditFormProps> = ({item, submited, submitHandler, deleteHandler, cancelSubmitHandler}) => {

    const [form, setForm] = useState<IPartModelEditData>(initialFormState)
    ...
    // const validateFormHandler = (form: IPartModelEditData, field: string) => {
    //
                ...
                <div className="w-11/12 mx-auto h-fit">
                    <div>
                        ...
                        <div className="my-5">
                            <div>
                                <div className="flex flex-row w-full">
                                    <Checkbox checked={(form.part_number?.length || 0) > 0} disabled={true}/>
                                    <TextField
                                        id="standard-helperText"
                                        label="Part number"
                                        variant="outlined"
                                    ...
                                    />
                                    <Typography variant="inherit"
                                                className="w-11/12 ml-10 text-2xs my-4">{"Previous: " + item.part_number}</Typography>
                                </div>
                            </div>
                        </div>
                        <div className="my-5">
                            <div>
                                <div className="flex flex-row w-full">
                                    <Checkbox checked={(form.mpn?.length || 0) > 0} disabled={true}/>
                                    <TextField
                                        id="standard-helperText"
                                        label="MPN"
                                        variant="outlined"
                                    ...
                                    />
                                    <Typography variant="inherit"
                                                className="w-11/12 ml-10 text-2xs my-4">{"Previous: " + item.mpn}</Typography>
                                </div>
                            </div>
                        </div>
                        <div className="my-5">
...
export default PartModelEditForm;
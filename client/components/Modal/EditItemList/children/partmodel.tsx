...
import {IPartModelListItem} from "../../../../types/partsmodel";

interface IPartModelEditListProps{
    checked: string[],
    setChecked: Dispatch<SetStateAction<string[]>>
}

const PartModelEditList: FC<IPartModelEditListProps> = ({checked, setChecked}) => {

    const {PartList} = useTypeSelector(state => state.part)


    const handleToggle = (value: IPartModelListItem) => () => {
...
export default PartModelEditList;

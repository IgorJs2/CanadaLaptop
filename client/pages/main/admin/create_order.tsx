        ...
        <MainLayouts active={2}>
            <div className="w-11.5/12 ml-20  h-full overflow-x-hidden">
                <div className="w-6/12 rounded-2xl flex flex-col justify-center items-center mx-auto mt-16 h-fit pb-32 rounded-box bg-main-dark">
                    <div className="flex text-white text-2xl pt-16">Create order</div>
                    <div className="w-full flex flex-col justify-center items-center text-white mt-6">

                        <FormControl className="bg-main-dark-2 border-none text-white w-8/12 mr-6 mt-6">
                            <InputLabel id="demo-simple-select-helper-label">Laptop ID</InputLabel>
                            <Select className="w-full bg-main-dark-2"
                                    label="Laptop ID" value={select} onChange={handleChange}>
                        ...
                        <FormControl className="bg-main-dark-2 border-none text-white w-8/12 mr-6 mt-6">
                            <InputLabel id="demo-simple-select-helper-label">Part ID</InputLabel>
                            <Select className="w-full bg-main-dark-2"
                                    label="Part ID" value={select} onChange={handleChange}>
                                <MenuItem value={'Homer'}>Homer</MenuItem>
                                <MenuItem value={'Marge'}>Marge</MenuItem>
                                <MenuItem value={'Bart'}>Bart</MenuItem>
                                <MenuItem value={'Lisa'}>Lisa</MenuItem>
                        ...
                        <TextField placeholder="Customer Shipping Adress"
                                   className="bg-main-dark-2 border-none text-white w-8/12 mr-6 mt-6"/>
                        <TextField placeholder="Tracknumber"
                                   className="bg-main-dark-2 border-none text-white w-8/12 mr-6 mt-6"/>
